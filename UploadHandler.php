...
class UploadHandler
{
    ...
    protected $error_messages = array(
        1 => 'Размер загруженного файла превышает установленные ограничения в php.ini',
        2 => 'Размер загружаемого файла превышает значение директивы, которая была указана в HTML форме',
        3 => 'Загруженный файл был загружен лишь частично',
        4 => 'Файл не был загружен',
        6 => 'Отсутствие временной папки',
        7 => 'Не удалось записать файл на диск',
        8 => 'Расширение PHP остановил загрузку файлов',
        'post_max_size' => 'Размер загруженного файла превышает установленные ограничения в php.ini',
        'max_file_size' => 'Файл слишком большой',
        'min_file_size' => 'Файл слишком маленький',
        'accept_file_types' => 'Запрещенный тип файла',
        'max_number_of_files' => 'Нельзя одновременно грузить более одного файла',
        'max_width' => 'Превышены допустимые размеры изображения',
        'min_width' => 'Слишком маленькое изображение',
        'max_height' => 'Превышены допустимые размеры изображения',
        'min_height' => 'Слишком маленькое изображение'
    );
