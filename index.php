...
Впрочем, как всегда.
  ...
  <div class="customtext_23">



    <button type="button" class="btn btn-small btn-inverse">Очистить</button>
    <button type="button" class="btn btn-small" data-fontsize="12" data-toggle="popover" data-original-title="Универсальные (для женщин)" data-fontsize="11" data-content="          Чего мы хотим
Того хочет сам бог! А значит, он хочет, чтобы 
вы, мужчины, носили нас на руках. Для этого 
          ...
          <div class="accordion-group">
            ...
            <div id="collapseThree" class="accordion-body in collapse" style="height: auto;">
              <div class="accordion-inner">
                ...
                <div class="row-fluid custom_text"></div>
              </div>
            </div>
          </div>
          <div class="accordion-group">
